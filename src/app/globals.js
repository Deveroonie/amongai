const models = [
    ...
    {name: "GPT 5.1 Instant", api: "openai/gpt-5.1-instant", provider: "OpenAI"},
    {name: "GPT 5.1 Thinking", api: "openai/gpt-5.1-thinking", provider: "OpenAI"},
    {name: "GPT 5.2", api: "openai/gpt-5.2", provider: "OpenAI"},
    ...
    {name: "Gemini 3 Flash", api: "google/gemini-3-flash", provider: "Google"},
    // xAI
    {name: "Grok 2", api: "xai/grok-2", provider: "xAI"},
    {name: "Grok 3", api: "xai/grok-3", provider: "xAI"},
    {name: "Grok 3 Fast", api: "xai/grok-3-fast", provider: "xAI"},
    ...
    {name: "Qwen 3 Max Thinking", api: "alibaba/qwen3-max-thinking", provider: "Alibaba"},
    // Minstral
